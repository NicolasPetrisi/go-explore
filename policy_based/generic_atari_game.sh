...
#CELL_SELECTION_OPTIONS="--selector weighted --selector_weights=target_cell,x,20,y,18  --load_archive"
...
MISC_OPTIONS="--low_prob_traj_tresh 0.01 --start_method fork --log_info INFO --log_files __main__ ${Load} ${MaxTime}"
