...
EPISODE_OPTIONS="--trajectory_tracker sparse_soft --soft_traj_win_size 10 --random_exp_prob 0.0 --max_actions_to_goal 1000 --max_actions_to_new_cell 1000 --delay 0"
